...
DATAFILE = 'file_name.csv' # Enter the absolute path to this file (targets_from_csv.csv)
# DATAFILE = 'targets_from_csv_copy.csv'  # Enter the absolute path to this file (targets_from_csv.csv)
